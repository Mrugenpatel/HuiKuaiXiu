//
//  HKXMineDefaultAddressExistData.h
//
...
@interface HKXMineDefaultAddressExistData : NSObject <NSCoding, NSCopying>

@property (nonatomic, copy  ) NSString *consigneesTel;//收货人电话
...
@property (nonatomic, copy  ) NSString *consigneesAdd;//收货人地址
